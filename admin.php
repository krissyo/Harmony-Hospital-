...
<html>
    ...
    <body>
        <div class="Container">
            ...
            <div class="headerBar">
                ...
                <div id="harmony_logo">
                    <a href="http://www.inb201harmony.firelabscloud.com/index.php"><img src="images/bandaid_bird_90px.png"></a>
                </div>
    ...
    <div class="contentColumn">
                ...
                <div class="contentLinkingBox">
                    <a href="http://www.inb201harmony.firelabscloud.com/newpatient.php" target="_blank"><h1>ADMIT NEW <br />PATIENT</h1></a>
                </div>
        
                <div class="contentLinkingBox">
                    <a href="http://www.inb201harmony.firelabscloud.com/patientdetail.php" target="_blank"><h1>UPDATE PATIENT <br /> DETAILS</h1>                     </a>
                </div>
        
                <div class="contentLinkingBox">
                    <a href="http://www.inb201harmony.firelabscloud.com/searchpatient.php" target="_blank"><h1>SEARCH FOR<br />A PATIENT</h1></a>
                </div><!-- ends first row of buttons -->
        
                <!-- second row of buttons -->
                <div class="contentLinkingBox">
                    <a href="http://www.inb201harmony.firelabscloud.com/consent.php" target="_blank"><h1>PATIENT CONSENT <br /> FORM</h1></a>
                </div>
        
                <div class="contentLinkingBox">
                    <a href="http://www.inb201harmony.firelabscloud.com/terms_and_conditions.php" target="_blank"><h1>TERMS AND
                    <br />CONDITIONS</h1></a>
