...
<!-- first row of buttons -->
                ...
                <div class="nurseLinkingBoxes">
                    <a href="http://www.trustinblack.com/harmonyhospital/nursenotes.php" target="_blank"><h1>NURSES <br /> NOTES</h1></a>
                </div>

                <div class="nurseLinkingBoxes">
                    <a href="http://www.trustinblack.com/harmonyhospital/annualleave.php" target="_blank"><h1>ANNUAL<br />LEAVE</h1></a>
                </div>
        
                 <div class="nurseLinkingBoxes">
                    <a href="http://www.trustinblack.com/harmonyhospital/bedmanagement.php" target="_blank"><h1>BED <br /> MANAGEMENT</h1></a>
                </div>
