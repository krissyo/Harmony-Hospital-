...
<html>
    <head>
        ...
        <link href="<?php $_SERVER["DOCUMENT_ROOT"] ?>/css/style.css" rel="stylesheet" type="text/css" />
        <!--<link href="<?php $_SERVER["DOCUMENT_ROOT"] ?>/Harmony_main.css" rel="stylesheet" type="text/css" />-->
        <link href="<?php $_SERVER["DOCUMENT_ROOT"] ?>/globalstyle.css" rel="stylesheet" type="text/css" />
        <link rel="shortcut icon" href="<?php $_SERVER["DOCUMENT_ROOT"] ?>/bandaid_bird_48x48.ico" type="image/x-icon" />
        
        <!-- Javascript -->        
        <script src="<?php $_SERVER["DOCUMENT_ROOT"] ?>/lib/jquery-1.11.0.min.js"></script>
        <!--<script src="<?php $_SERVER["DOCUMENT_ROOT"] ?>/lib/mainpage.js"></script>-->
        <script src="<?php $_SERVER["DOCUMENT_ROOT"] ?>/lib/adminInclude.js"></script>
            ...
            <div class="headerBar">
                ...
                <div id="TopMenuBar">
                    ...
                    <div class="action_buttons" id="LogoutButton">
                        <a action="<?php $_SERVER["DOCUMENT_ROOT"] ?>submit/logout.php" href="loggedoff.html"><h1>LOG OUT</h1></a>
                    </div>
                    <div id="MailBox"><img src="<?php $_SERVER["DOCUMENT_ROOT"] ?>/images/mail_box.png"/>
                    </div>
